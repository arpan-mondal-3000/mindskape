                            ...
                            //contener of the all imafe textfield and button
                              ...
                              child: Column(
                                children: [
                                  ...
                                  }, "SIGN UP", Colors.cyanAccent.shade100, Colors.blue,20 ),
                                  SizedBox(
                                    height: 10,
                                  ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        TextButton(onPressed: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=> LoginActivity()));

                                        }, child: Text("LOGIN",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16,color: Colors.blue.withOpacity(.8),decoration: TextDecoration.underline,decorationColor: Colors.blue),))
                                      ],
                                    ),
                                  )
